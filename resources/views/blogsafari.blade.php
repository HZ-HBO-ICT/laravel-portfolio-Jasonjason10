...
<main>
    ...
    <img src="img.jpg/google-logo.jpg" alt="Google logo" width="350" height="290">
    <h1>Google</h1>
    <p>Core Buissness:Big data</p>
    ...
    <p>Positie: Product manager costumer succes, Support medewerker, Financial controller, Software developer team web apps, Frost-end developer</p>
    <p>Technologie: Syntess werkt met ERP Software dat staat voor Enterprise Resource Planning dit bied ondersteunig voor alle processen in het bedrijf in plaats van meerdere softwarepakketen wat bij andere bedrijven plaatvindt.</p>
    <p>Voor: In zeeland dus ik hoef niet uit de provincie verhuizen. tegen:</p>
</main>
@endsection
